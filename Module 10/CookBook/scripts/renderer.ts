...
export class Renderer {
    ...
    renderCategories(recipeCategoriesSummary: RecipeCategories.RecipeCategories<RecipeInterfaces.IRecipeCategorySummary>) {
    ...
    renderCategory(category: RecipeInterfaces.IRecipeCategory) {
    ...
    renderExamples(category: RecipeInterfaces.IRecipeCategory) {
        //Update examples
